...
export async function GET(request: NextRequest) {
  try {
    ...
    let backendUrl = `http://localhost:8000/api/reports/${reportType}/`;
    ...
    if (!backendResponse.ok) {
      ...
      return new NextResponse(errorData, {
        ...
        headers: {
          ...
          'Content-Disposition': backendResponse.headers.get('Content-Disposition') || 'attachment; filename=report',
        },
      });
    }
